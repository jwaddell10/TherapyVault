	...
	return (
		<div className="home-page-container">
			...
			<p className="instructions">
				Welcome to the virtual Therapy File Cabinet (TherapyVault). I
				created this as a way to keep track of worksheets,
			...
			{authed.authed === true ? (
				<Link to="/therapy-worksheets">
					<Button text="Get Started" className="button"></Button>
				</Link>
			) : (
				<Link to="/log-in">
					<Button text="Get Started" className="button"></Button>
			...
			<div className="example-images">
				...
				/>
				<img
					src="https://res.cloudinary.com/dak6py2ng/image/upload/v1732564029/Screenshot_2024-11-25_at_1.46.02_PM_gztwla.png"
					alt="example image"
				/>
				<img
					src="https://res.cloudinary.com/dak6py2ng/image/upload/v1732564377/Screenshot_2024-11-25_at_1.52.24_PM_hnpmnl.png"
					alt="example image"
				/>
			</div>
		</div>
